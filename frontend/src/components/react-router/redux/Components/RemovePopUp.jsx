   ...
   function cancelHandler() {
    ...
    return (
        ...
        <div ref={ref} className={styles.removePopUp_container}>
            ...
            <button tabIndex={'2'} onClick={cancelHandler}  className={styles.cancel_button}>Отменить</button>
            <button tabIndex={'3'} onKeyDown={(e) => keyDownHandler(e,currentId)} onClick={(e) => handleRemove(e, currentId)} className={styles.delete_button}>Удалить</button>
            </div>
        </div>
            </div>
    )
